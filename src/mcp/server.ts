...
export function buildPartQuillMcpServer(dependencies: PartQuillMcpDependencies = {}): McpServer {
  ...
  const server = new McpServer(
    { name: 'partquill-image-studio', version: '0.22.0' },
    {
      instructions:
  ...
  registerAppTool(
    ...
    'prepare_community_image_edit',
    {
      ...
      description:
        'Use only with a PartQuill owner-issued handoff code and the matching reviewed source image. Returns the exact PartQuill preservation prompt for one rights-attested community part photograph.',
      inputSchema: {
